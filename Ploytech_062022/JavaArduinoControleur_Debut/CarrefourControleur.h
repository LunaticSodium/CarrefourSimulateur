...
#define DELAYDEROUGE            6000          //delay of the red light
//CHANGE HERE
#define DELAYDEMAINSR           15000         //delay of the main ssrrrr. Sub R also content.
#define DELAYDEMAINLR           10000         //delay of the main llrrrr, etc

#define DELAYDEMAINSP           10000         //rely on Pmain(note: m=n+s but Pm=Wp+Ep)
#define DELAYDESUBSP            10000         //rely on Subs et Subp
#define DELAYDESUBLR            10000         //rely on Subl
#define DELAYDEALLP             15000         //only when 4/3 bottons trigger
...
#define SEUILLEFTDECAPTEUR      1.2           //V. voltage threshold between null/idle, left, stright and right.
#define SEUILSTRDECAPTEUR       1.8
#define SEUILRIGHTDECAPTEUR     2.5

#define BOUTONDELAY             2             //PIN. mecanism of voting of bottons, not forced and not useful.
...
namespace CarfCont
{
    ...
    private:
        ...
        const int _numdeLED = 16;
        const int _numdestats = 7;
    ...
    class Syscarrefour                                                                         //For integre looper, capteur and bouton by arduino. Finish.
    {
    private:
